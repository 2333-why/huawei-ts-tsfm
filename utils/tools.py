...
class EarlyStopping:
    def __init__(self, patience=7, verbose=False, delta=0, on_save=None):
    ...
    def __call__(self, val_loss, model, path, model_name='checkpoint.pth'):
        score = -val_loss
