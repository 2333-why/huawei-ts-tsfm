...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        # Project the encoded history to the requested forecast horizon.  The
        # upstream implementation only emitted one value per encoder step,
        # which truncated horizons longer than ``configs.seq_len``.
