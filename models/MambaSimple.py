...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        # Map the encoded history positions to exactly the requested forecast
        # horizon; this also supports pred_len values longer than seq_len.
        self.temporal_projection = nn.Linear(configs.seq_len, self.pred_len)
...
class MambaBlock(nn.Module):
    def __init__(self, configs, d_inner, dt_rank):
        ...
        # takes in x and outputs the icudat-specific delta, B, C
